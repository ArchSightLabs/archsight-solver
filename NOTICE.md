...
官方演示站可在运行时加载 Busuanzi 公开 PV/UV 脚本和 ArchSight 自托管 Umami 统计脚本；它们不随源码或离线制品捆绑，也不是求解、工程文件或计算书导出的运行依赖。派生部署默认不应向官方统计服务发送数据，配置和隐私边界见 [访问统计与隐私边界](docs/analytics-and-privacy.md)。
