...
- 对象摘要、基本页、结果页、结构预览、荷载编辑器、模板库和计算书选项统一使用共享对象词表；框架使用“构件”，桁架使用“杆件”，梁系使用“跨段 / 支座”，降低跨模块术语漂移。
...
- 新增 `AGENTS.md`、`CLAUDE.md`、`GEMINI.md` 和 `AI_CODING_RULES.md`，把项目定位、结构工程术语、中文输出、版本同步和验证要求沉淀为 AI 编码入口。
