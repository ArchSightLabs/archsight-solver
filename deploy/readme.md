...
当前仓库稳定版本为 2026-08-23 发布的 v1.8.0。GitHub Tag Release 生成 GitHub Release、不可变 GHCR 镜像和校验制品；只有目标镜像仓库中的 v1.8.0 不可变镜像真实存在并完成摘要核对后才能部署，其他目标镜像仓库推送及线上更新仍由维护者独立执行。
