...
NODAL_LOAD_SCHEMA: Dict[str, Any] = {
    ...
    "properties": {
        ...
        "pathRole": {"type": "string", "enum": ["fixed", "variable"], "description": "共回转路径中的固定预荷载或可缩放变量荷载。"},
    },
    "additionalProperties": True,
}
...
MEMBER_DISTRIBUTED_LOAD_SCHEMA: Dict[str, Any] = {
    ...
    "properties": {
        ...
        "pathRole": {"type": "string", "enum": ["fixed", "variable"]},
    },
    "additionalProperties": True,
}
...
FRAME_PDELTA_OPTIONS_SCHEMA: Dict[str, Any] = {
    ...
    "properties": {
        ...
        "initialStep": {"type": "number", "exclusiveMinimum": 0, "maximum": 1},
        "minStep": {"type": "number", "exclusiveMinimum": 0, "maximum": 1},
        "maxStep": {"type": "number", "exclusiveMinimum": 0, "maximum": 1},
        "maxCutbacks": {"type": "integer", "minimum": 0, "maximum": 30},
        "maxAcceptedSteps": {"type": "integer", "minimum": 1, "maximum": 20000},
        "relativeResidualTolerance": {"type": "number", "exclusiveMinimum": 0},
        "absoluteResidualToleranceN": {"type": "number", "exclusiveMinimum": 0},
        "relativeDisplacementTolerance": {"type": "number", "exclusiveMinimum": 0},
        "absoluteDisplacementToleranceM": {"type": "number", "exclusiveMinimum": 0},
        "relativeEnergyTolerance": {"type": "number", "exclusiveMinimum": 0},
        "absoluteEnergyToleranceJ": {"type": "number", "exclusiveMinimum": 0},
        "lineSearchMaxTrials": {"type": "integer", "minimum": 1, "maximum": 20},
        "memberSubdivisions": {"type": "integer", "minimum": 1, "maximum": 12},
        "maxRefinedDofs": {"type": "integer", "minimum": 30, "maximum": 5000},
        "includeMethodComparison": {"type": "boolean"},
        "initialImperfection": {
            "type": "object",
            "properties": {
                "type": {"type": "string", "enum": ["none", "explicit", "buckling_mode"]},
                "nodeOffsets": {
                    "type": "array",
                    "items": {
                        "type": "object",
                ...
                "modeNumber": {"type": "integer", "minimum": 1, "maximum": 12},
                "amplitudeMm": {"type": "number", "minimum": 0},
...
FRAME_NONLINEAR_PATH_KEY_POINT_SCHEMA: Dict[str, Any] = {
    "type": "object",
    "required": ["id", "kind", "source", "sourceIndex", "step", "pathProgress", "loadFactor"],
    "properties": {
        "id": {"type": "string"},
        "kind": {
            "type": "string",
        ...
        "source": {"type": "string", "enum": ["keyframe", "step", "iteration", "attempt", "finalAttempt"]},
        "sourceIndex": {"type": "integer", "minimum": 0},
        "step": {"type": "integer", "minimum": 0},
        "pathPhase": {"type": "string", "enum": ["fixed_preload", "variable"]},
        "pathProgress": {"type": "number"},
        "fixedLoadFactor": {"type": "number"},
        "loadFactor": {"type": "number"},
        "maxDisplacementMm": {"type": ["number", "null"]},
        "minimumTangentEigenvalue": {"type": ["number", "null"]},
        "equilibriumResidualRelative": {"type": ["number", "null"]},
        "status": {"type": ["string", "null"]},
        "stabilityStatus": {"type": ["string", "null"]},
    },
    "additionalProperties": False,
}

FRAME_NONLINEAR_PATH_TRACE_SCHEMA: Dict[str, Any] = {
    "type": "object",
    "required": [
        "schema",
        "algorithm",
    ...
    "properties": {
        "schema": {"type": "string", "const": "NonlinearPathTrace@1"},
        "algorithm": {"type": "object", "additionalProperties": True},
        ...
        "representativeElementState": {"type": ["object", "null"], "additionalProperties": True},
        "steps": {"type": "array", "items": {"type": "object", "additionalProperties": True}},
        "iterations": {"type": "array", "items": {"type": "object", "additionalProperties": True}},
        ...
        "keyPoints": {"type": "array", "items": FRAME_NONLINEAR_PATH_KEY_POINT_SCHEMA},
        "lastConverged": {"type": "object", "additionalProperties": True},
        "finalAttempt": {"type": ["object", "null"], "additionalProperties": True},
        "summary": {"type": "object", "additionalProperties": True},
    },
    "additionalProperties": False,
}

FRAME_METHOD_COMPARISON_SCHEMA: Dict[str, Any] = {
    "type": "object",
    "required": ["schema", "methods", "metrics", "limitations"],
    "properties": {
        "schema": {"type": "string", "const": "MethodComparison@1"},
        "methods": {
            "type": "array",
            "items": {
                "type": "object",
                "required": ["id", "label", "equilibriumStatus", "stabilityStatus", "sourceHash", "requestHash", "modelHash", "referenceSource"],
                "properties": {
                    "id": {"type": "string", "minLength": 1},
                    "label": {"type": "string", "minLength": 1},
                    "equilibriumStatus": {"type": "string"},
        ...
        "metrics": {
            ...
            "items": {
                "type": "object",
                "required": ["id", "unit", "comparable", "unavailableReason", "values"],
                "properties": {
                    "id": {"type": "string"},
                    "unit": {"type": "string"},
...
FRAME_SECOND_ORDER_RESULT_SCHEMA: Dict[str, Any] = {
    ...
    "properties": {
        ...
        "algorithm": {
            ...
            "required": ["id", "version"],
            "properties": {
                "id": {"type": "string", "enum": ["initial_stress_v1", "corotational_newton_v1"]},
                "version": {"type": "string"},
            },
            "additionalProperties": True,
        },
        "equilibriumStatus": {"type": "string", "enum": ["not_enabled", "converged", "not_converged"]},
        "stabilityStatus": {"type": "string", "enum": ["not_evaluated", "stable", "near_critical", "unstable"]},
        "referenceSource": {"type": "object", "additionalProperties": True},
        "loadSteps": {"type": "integer"},
        "maxIterations": {"type": "integer"},
        "tolerance": {"type": ["number", "null"]},
        "totalIterations": {"type": "integer"},
        "amplificationFactor": {"type": ["number", "null"]},
        "amplificationUnavailableReason": {"type": ["string", "null"]},
        ...
        "nonlinearPathTrace": {"oneOf": [{"type": "null"}, FRAME_NONLINEAR_PATH_TRACE_SCHEMA]},
        "methodComparison": {"oneOf": [{"type": "null"}, FRAME_METHOD_COMPARISON_SCHEMA]},
        "lastConverged": {"type": ["object", "null"], "additionalProperties": True},
        "lastConvergedSolution": {"type": ["object", "null"], "additionalProperties": True},
        "initialImperfection": {"type": ["object", "null"], "additionalProperties": True},
        "firstOrder": FRAME_STABILITY_REFERENCE_RESULTS_SCHEMA,
        "solution": {"type": ["object", "null"], "additionalProperties": True},
        "final": {"type": ["object", "null"], "additionalProperties": True},
