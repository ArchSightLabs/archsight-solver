...
_CATEGORY_BY_CODE = {
    ...
    "FRAME_PDELTA_NOT_CONVERGED": "solver",
    "FRAME_PDELTA_TANGENT_SINGULAR": "solver",
    "FRAME_BUCKLING_EIGEN_FAILURE": "solver",
    "FRAME_BUCKLING_RESIDUAL_FAILURE": "solver",
...
_ACTION_BY_CODE = {
    ...
    "FRAME_PDELTA_NOT_CONVERGED": ("review_stability_analysis", "检查稳定分析参数"),
    "FRAME_PDELTA_TANGENT_SINGULAR": ("review_stability_analysis", "检查稳定分析参数"),
    "FRAME_BUCKLING_EIGEN_FAILURE": ("review_stability_analysis", "检查稳定分析参数"),
    "FRAME_BUCKLING_RESIDUAL_FAILURE": ("review_stability_analysis", "检查稳定分析参数"),
