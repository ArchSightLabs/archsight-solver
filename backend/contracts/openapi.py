...
def _public_example_projects_response_schema() -> Dict[str, Any]:
    benchmark_meta = {
        ...
        "properties": {
            ...
            "verificationLevel": {"type": "string", "enum": ["A", "B", "C", "D"]},
            "verificationLevelLabel": {"type": "string"},
            "verificationLevelDescription": {"type": "string"},
            ...
            "projects": {
                ...
                "items": {
                    ...
                    "properties": {
                        ...
                        "verificationLevels": {"type": "array", "items": {"type": "string", "enum": ["A", "B", "C", "D"]}},
