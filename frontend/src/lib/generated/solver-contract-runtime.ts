...
export const SOLVER_HOST_MESSAGE_TYPES = ["archsight.solver.host.launch", "archsight.solver.host.requestSave", "archsight.solver.host.saveResult", "archsight.solver.ready", "archsight.solver.project.changed", "archsight.solver.project.saveRequest", "archsight.solver.portal.actionRequested", "archsight.solver.theme.changed", "archsight.solver.error"] as const;
