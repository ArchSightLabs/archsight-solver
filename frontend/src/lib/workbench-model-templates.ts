...
export const BEAM_MODEL_TEMPLATES: BeamModelTemplate[] = [
  {
    ...
    state: {
      ...
      freq: 1.2,
      duration: 5,
      spans: [{ id: "B1", length: 6, E: 210, I: 8000 }],
      supports: [
        { id: "N1", x: 0, type: "pinned" },
        { id: "N2", x: 6, type: "roller" },
      ],
    },
  },
  {
    ...
    state: {
      ...
      freq: 1.2,
      duration: 5,
      spans: [{ id: "B1", length: 4, E: 206, I: 5200 }],
      supports: [{ id: "N1", x: 0, type: "fixed" }],
    },
  },
  {
    ...
    state: {
      ...
      duration: 5,
      spans: [
        { id: "B1", length: 5, E: 210, I: 9000 },
        { id: "B2", length: 5, E: 210, I: 9000 },
      ],
      supports: [
        { id: "N1", x: 0, type: "pinned" },
        { id: "N2", x: 5, type: "pinned" },
        { id: "N3", x: 10, type: "roller" },
      ],
    },
  },
  {
    ...
    state: {
      ...
      duration: 5,
      spans: [
        { id: "B1", length: 4, E: 32.5, I: 12000 },
        { id: "B2", length: 5, E: 32.5, I: 14000 },
        { id: "B3", length: 4, E: 32.5, I: 12000 },
      ],
      supports: [
        { id: "N1", x: 0, type: "pinned" },
        { id: "N2", x: 4, type: "pinned" },
        { id: "N3", x: 9, type: "pinned" },
        { id: "N4", x: 13, type: "roller" },
      ],
    },
  },
];
...
export function cloneBeamModelTemplate(template: BeamModelTemplate): BeamWorkspaceState {
  return {
    ...
    spans: template.state.spans.map((span, index) => ({ id: span.id ?? `B${index + 1}`, materialId: template.state.materialId, ...span })),
