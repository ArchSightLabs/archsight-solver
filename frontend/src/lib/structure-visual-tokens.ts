...
export const STRUCTURE_VISUAL_STROKES = {
  ...
  previewMember: 4,
  previewFrameDeformedMember: 1.8,
  previewTrussMember: 2,
  previewTrussLoad: 1.15,
  previewTrussDeformedMember: 1.5,
  resultBeamBase: 1.5,
  resultOverlayBase: 4,
  resultFrameDiagram: 1.5,
  resultTrussBase: 1.5,
  resultTrussAxialMin: 1.5,
  resultTrussAxialMax: 3.5,
  resultTrussDeformedMember: 1.5,
  reportBaseMember: 3.5,
  reportPreviewDeformedMember: 2.5,
} as const;
