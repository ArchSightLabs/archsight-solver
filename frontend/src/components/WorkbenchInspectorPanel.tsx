...
export function WorkbenchInspectorPanel({
  ...
  return (
    <aside className="relative xl:sticky xl:top-24 xl:max-h-[calc(100vh-11.5rem)]">
      <AnimatePresence mode="wait" initial={false}>
        {collapsed ? (
          ...
          >
            <GlassCard className="flex min-h-[22rem] w-[4.5rem] flex-col items-center gap-3 p-2 xl:h-[calc(100vh-7rem)]">
              <Button
                type="button"
                variant="outline"
                size="icon"
          ...
          >
            ...
            <GlassCard className="inspector-panel flex min-h-0 flex-col gap-4 p-4 sm:p-5 xl:h-[calc(100vh-7rem)]">
              <ModuleSectionNav
