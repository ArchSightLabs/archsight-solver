...
当前状态：**发布候选**。代码与仓库内验收按 `1.6.2` 收口，但尚未创建 tag 或 GitHub Release，也未更新线上服务器；维护者可以先构建候选 Docker 镜像，正式推送与部署仍单独决策。
...
完整门禁与从线上 v1.6.0 直接升级、回滚的操作边界见 [v1.6.2 发布候选验收](docs/verification/release-1-6-2-acceptance.md)。
...
| [v1.6.2 发布候选验收](docs/verification/release-1-6-2-acceptance.md) | 工作台与宿主接入统一验收、镜像门禁、升级与回滚 | v1.6.2 发布候选 |
