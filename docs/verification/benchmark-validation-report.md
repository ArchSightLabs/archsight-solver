...
| `BM-002` | truss-verify | A 级验证 | 通过 | 最大节点位移(mm)=0.16200868065787996（标准 0.162）；最大杆件轴力(kN)=31.249999999999996（标准 31.25）；N2 水平位移(mm)=0.14765624999999996（标准 0.14765625）；N2 竖向位移(mm)=-0.06666666666666667（标准 -0.0666666667）；N3 水平位移(mm)=0.09999999999999999（标准 0.1）；N3 竖向位移(mm)=0.0（标准 0） |
...
| `BM-009` | truss-verify | A 级验证 | 通过 | 最大节点位移(mm)=0.325（标准 0.325）；最大杆件轴力(kN)=50.0（标准 50）；N2 水平位移(mm)=0.07999999999999999（标准 0.08）；N2 竖向位移(mm)=-0.315（标准 -0.315）；N3 水平位移(mm)=0.15999999999999998（标准 0.16）；N3 竖向位移(mm)=0.0（标准 0） |
