...
| `BM-002` | truss-verify | A 级验证 | 通过 | 最大节点位移(mm)=0.16200868065787996（标准 0.162）；最大杆件轴力(kN)=31.249999999999996（标准 31.25）；M1 杆件轴力(kN)=31.249999999999996（标准 31.25）；M1 拉压状态=tension（标准 tension）；M2 杆件轴力(kN)=-31.249999999999996（标准 -31.25）；M2 拉压状态=compression（标准 compression） |
