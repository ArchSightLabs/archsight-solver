...
> 状态：已发布并上线。代码、数值、浏览器、正式制品、公开离线镜像、回滚、阿里云镜像与官方演示站门禁均已通过，P0/P1 为 0。GHCR 是可能需要授权的工作流镜像副本，不是官方线上部署仓库。
...
- [ ] 维护者已明确授权 v1.8.0 正式发布，所有版本事实源统一为 `1.8.0`；线上部署完成后单独记录镜像、健康与回滚证据。
