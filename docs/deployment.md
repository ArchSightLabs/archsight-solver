...
当前仓库版本事实源为 v1.8.2。发布候选验证期间，官方演示站继续运行已核对的 v1.8.1 阿里云精确镜像 `v1.8.1-e48507d`；只有 v1.8.2 的 GitHub Release、目标镜像仓库与线上容器分别完成核对后，才更新生产事实。本文件不把仓库版本、Tag Release、镜像推送或线上部署误写为同一状态。
