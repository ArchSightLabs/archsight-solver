...
```powershell
docker build -t archsight-solver:v1.2.0 -t registry.example.com/example-namespace/archsight-solver:v1.2.0 .
```

推送：

```powershell
docker push registry.example.com/example-namespace/archsight-solver:v1.2.0
```
