...
当前仓库版本事实源为 v1.8.3 发布候选。官方演示站仍运行已于 2026-08-25 验收的阿里云精确镜像 `v1.8.2-1fdbf13`，并保持 `127.0.0.1:18082 -> app:6240`；v1.8.3 的 GitHub Release、阿里云镜像和线上容器必须分别完成后才能记录为正式发布。`v1.8.2-1fdbf13` 作为直接回滚基线继续保留。本文件不把仓库版本、Tag Release、镜像推送或线上部署误写为同一状态。
